...
// Lắng nghe sự kiện click trên button "Xem chi tiết"
...
document.addEventListener("DOMContentLoaded", function () {
    var clampItems = document.querySelectorAll('.clamp-me');
    clampItems.forEach(function (item) {
        var lineHeight = parseFloat(window.getComputedStyle(item).lineHeight);
        var maxHeight = lineHeight * 5; // Chiều cao tối đa của 5 dòng
